...
export default function Header() {
    ...
    const {signOut, signIn} = useContext(DatabaseContext);
    ...
    return (
        <>
            <Modal active={uploadModalActive} setActive={setUploadModalActive} classStyle="upload-modal-content">
                <FileUpload active={uploadModalActive} setActive={setUploadModalActive}/>
            </Modal>
            <Modal active={updateModalActive} setActive={setUpdateModalActive} classStyle="upload-modal-content">
                <ProfileUpdate active={updateModalActive} setActive={setUpdateModalActive}/>
            </Modal>
        <header>
                        ...
                        {userDetails ? (<>
                                <button
                                    ...
                                    <svg viewBox="0 0 19 19"
                                         className={updateModalActive ? "active" : ""}>
                                        <path
                                            strokeLinecap="round"
                                ...
                                <button
                                    ...
                                    >
                                    <svg viewBox="0 0 19 19"
                                         className={uploadModalActive ? "active" : ""}>
                                        <path
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                            strokeWidth={4}
                                ...
                                <button
                                    type="button"
                                    title="Sign Out"
                                    onClick={() => {signOut(); history.push(ROUTES.LOGIN)}}
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                ...
                                <div className="avatar">
                                    <Link to={`/u/${userDetails.username}`}>
                                        <img src={!!userDetails ? "http://localhost:8080/api/files/" + userDetails.photo : "/images/profilepic.jpg"}
