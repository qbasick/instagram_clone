...
export interface IProduce {
    /** Curried producer */<Recipe extends (...args: any[]) => any,
    ...
    /** Curried producer with initial state */<Recipe extends (...args: any[]) => any,
        Params extends any[] = Parameters<Recipe>,
        T = Params[0]>(
        recipe: Recipe,
    ...
    /** Normal producer */<Base, D = Draft<Base>, Return = void>(
        base: Base,
